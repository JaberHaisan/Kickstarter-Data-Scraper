...
def extract_campaign_data(file_path):
    ...
    print(description_elem["content"])
    ...
    # # Title.
    # try:
    #     title_elem = soup.select('h2[class="type-24 type-28-sm type-38-md navy-700 medium mb3"]')
    #     title = title_elem[0].getText()
    # # Missing title in scrapped data so get it from file name.
    # except IndexError:
    ...
    # # Blurb.
    # try:
    #     blurb_elem = soup.select('p[class="type-14 type-18-md navy-600"]')
    #     blurb = blurb_elem[0].getText()
    # # Blurb missing.
    # except IndexError:
    #     blurb = ""
    # finally:
    ...
    # # Creator.
    # try:
    #     creator_elem = soup.select('a[class="m0 p0 medium soft-black type-14 pointer keyboard-focusable"]')
    #     creator = creator_elem[0].getText()
    # # Creator data missing.
    # except:
    #     creator = ""
    # finally:
